...
import WhistCover from "@/img/WhistCover.png"
import WhistGame from "@/img/WhistGame.png"
...
export default function Home() {
  ...
  return (
    <div>
      <Navbar
        section={section}
        aboutMeOnClick={scrollToAboutMe}
        projectsOnClick={scrollToProjects}
        contactMeOnClick={scrollToContactMe}
      />
        ...
        <div className={styles.top}>
          <div className={styles.left}>
            ...
            <div className={styles["buttons-wide"]}>
              ...
              <Button isHollow onClick={scrollToContactMe}>
                Contact Me
              </Button>
            </div>
          </div>
      ...
      <div className={styles.projects} ref={projectsRef}>
        ...
        <div className={styles["project-block"]}>
          ...
          <ul>
            ...
            <li>
              <b>Sass</b> for styling
            </li>
            <li>
              <b>Storybook</b> for component testing
            </li>
            <li>
              <b>Vitest</b> for unit testing
            </li>
          </ul>
        ...
        <div className={styles["project-block"]}>
          ...
          <p>
            My next step was to get Kirby moving. I found a{" "}
            <Link
              href="https://www.spriters-resource.com/ds_dsi/kssu/sheet/14758/"
              section="projects"
            >
              sprite sheet
            </Link>{" "}
        ...
        <div className={styles["project-block"]}>
          ...
          <div className={styles["image-wrapper"]}>
            <Image
              alt="Hackathon application screenshot"
              src={CodeToGiveScreenshot}
              width={0}
              height={0}
              sizes="100vw"
              style={{ width: "100%", height: "auto" }}
        ...
        <div className={styles["project-block"]}>
          ...
          <div className={styles["image-wrapper"]}>
            <Image
              alt="USThing screenshot"
              src={USThingScreenshot}
              width={0}
              height={0}
              sizes="100vw"
              style={{ width: "100%", height: "auto" }}
        ...
        <div className={styles["project-block"]}>
          ...
          <div className={styles["image-wrapper"]}>
            <Image
              alt="Robotics Team photo"
              src={RobogamesTeamPhoto}
              width={0}
              height={0}
              sizes="100vw"
              style={{ width: "100%", height: "auto" }}
      ...
      <div className={styles["contact-me"]} ref={contactMeRef}>
        ...
        <span>
          Email:{" "}
          <Link href="mailto:csjcheung@connect.ust.hk" section={"contact-me"}>
            csjcheung@connect.ust.hk
          </Link>
        </span>
        <span>
          Github:{" "}
        ...
        <Link
          href="https://jennifer-cheung.github.io/Portfolio/jennifer-cheung-cv.pdf"
          download
          section={"contact-me"}
        >
          Download my resume
